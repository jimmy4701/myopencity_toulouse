...
export class AdminUnverifiedAlternatives extends Component {
    state = {
        page: 0,
        total_pages: 0
    }
            ...
            return(
                <Grid stackable>
                    <Grid.Column width={16}>
                        <Header as='h3'>Alternatives non vérifiées</Header>
                    </Grid.Column>
                    <Grid.Column width={16}>
...
export default AdminUnverifiedAlternativesContainer = withTracker(() => {
    ...
    const alternatives = Alternatives.find({verified: false}).fetch()
    return {
        loading,
        alternatives
    }
