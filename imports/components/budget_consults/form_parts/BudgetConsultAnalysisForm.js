...
export default class BudgetConsultAnalysisForm extends Component {
    state = {
        budget_consult: {}
    }
    ...
    handleContentChange = (e) => {
        let {budget_consult} = this.state
        budget_consult.analysis_content = e.target.getContent()
        this.setState({budget_consult})
    }
    ...
    render(){
        ...
        return(
            <MainContainer>
                <Form>
                    <Form.Input
                        label="Titre de la phase d'analyse technique"
                        onChange={this.handleChange}
                        value={budget_consult.analysis_step_name}
                        name='analysis_step_name'
                    />
                    <Form.Field>
                        <label>Contenu pour la phase d'analyse technique</label>
                        <TinyMCE
                            content={budget_consult.analysis_content}
                            config={{
