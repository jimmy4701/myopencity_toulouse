...
export default class BudgetConsultResultsForm extends Component {
    state = {
        budget_consult: {}
    }
    ...
    render(){
        ...
        return(
            <MainContainer>
                <Form>
                    <Form.Input
                        label='Titre de la phase de résultats'
                        onChange={this.handleChange}
                        value={budget_consult.results_step_name}
                        name='results_step_name'
                    />
                    <Form.Field>
                        <label>Contenu pour la phase de résultats</label>
                        <TinyMCE
                            content={budget_consult.results_content}
                            config={{
