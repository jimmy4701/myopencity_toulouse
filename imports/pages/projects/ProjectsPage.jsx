...
export class ProjectsPage extends Component{
  ...
  */
  ...
  render(){
    ...
    const {projects_page_header_title, navbar_color, project_create_button_color} = Meteor.isClient && Session.get('global_configuration')
    ...
    if(!loading){
      return(
        ...
        <Grid.Column width={16} className="territory-projects-header">
            ...
            <Button positive={!project_create_button_color} style={{backgroundColor: project_create_button_color}} size="big" onClick={this.new_project}>Proposer un projet</Button>
          </Grid.Column>
